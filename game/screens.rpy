...
screen main_menu():
    ...
    ## 星空闪烁叠加层
    add Solid("#ffffff", xysize=(2,2)) pos (200, 80)  at star_twinkle(0.0)
    add Solid("#ffffff", xysize=(2,2)) pos (500, 50)  at star_twinkle(1.5)
    add Solid("#ffffff", xysize=(3,3)) pos (900, 120) at star_twinkle(0.8)
    add Solid("#ffffff", xysize=(2,2)) pos (1300, 60) at star_twinkle(2.5)
    add Solid("#ffffff", xysize=(3,3)) pos (1700, 80) at star_twinkle(1.2)
    add Solid("#ffffff", xysize=(2,2)) pos (350, 180) at star_twinkle(3.0)
    add Solid("#ffffff", xysize=(2,2)) pos (1100, 150) at star_twinkle(0.5)
    add Solid("#ffffff", xysize=(2,2)) pos (1600, 160) at star_twinkle(2.0)
    ...
    vbox:
        ...
        text "人类，是一种，会为了一捧土背后的记忆，所悲伤的动物":
    ...
    vbox:
        ...
        textbutton _("开始游戏") action Start() style "main_menu_button"
        textbutton _("读取游戏") action ShowMenu("load") style "main_menu_button"
        textbutton _("设置") action ShowMenu("preferences") style "main_menu_button"
        textbutton _("关于") action ShowMenu("about") style "main_menu_button"
        textbutton _("退出") action Quit(confirm=False) style "main_menu_button"
...
## 底部渐暗遮罩
image bottom_fade = "gui/bottom_fade.png"
